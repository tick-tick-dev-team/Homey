...
(
   ...
   COMM_WRITER          BIGINT NULL COMMENT '등록자ID',
   COMM_DATE            DATETIME NULL COMMENT '등록일시',
   COMM_UWRITER         BIGINT NULL COMMENT '수정자ID',
...
(
   ...
   POST_WRITER          BIGINT NULL COMMENT '등록자ID',
   POST_DATE            DATETIME NOT NULL COMMENT '등록일시',
   POST_UWRITER         BIGINT NULL COMMENT '수정자ID',
   POST_UPDATE          DATETIME NOT NULL COMMENT '수정일시',
   HOME_ID              BIGINT NOT NULL COMMENT '집ID',
